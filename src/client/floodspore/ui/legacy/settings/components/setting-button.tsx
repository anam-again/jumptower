...
import TextButton from "client/floodspore/ui/legacy/components/textButton";
...
export default function SettingButton(props: Props) {
	...
	const click = () => {
		...
		if (isInGame) Events.toggleSetting(props.setting);
		else store.toggleSetting(GetStatePlayerId(), props.setting);
	};
